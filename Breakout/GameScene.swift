...
//  Breakout
//
//  Created by Erin Chon on 3/8/23.
//
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        for brick in bricks {
            if contact.bodyA.node == brick ||
                ...
                score += 1
                updateLabels()
                ball.physicsBody!.velocity.dx = ball.physicsBody!.velocity.dx * CGFloat(1.0)
                ball.physicsBody!.velocity.dy = ball.physicsBody!.velocity.dy * CGFloat(1.0)
